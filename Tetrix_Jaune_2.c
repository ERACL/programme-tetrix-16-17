...
// Passage de la bascule
	...
	wait1Msec(100);
	avance_nulle_anyway(140, &dist, &done, &obs);
	wait1Msec(100);
	turnRightDeg_safe(155);
	obstacle = 0;
	wait1Msec(100);
	// Prise du cylindre
	...
	// Demi-tour
	turnLeftDeg_safe(185);
	wait1Msec(100);
	turnLeftDeg_safe(175);
	wait1Msec(100);
	avance_nulle_anyway(430, &dist, &done, &obs);
	wait1Msec(200);
	turnLeftDeg_safe(177);
	wait1Msec(100);

	// On atteint la base
	avance_nulle_anyway(650, &dist, &done, &obs);
	wait1Msec(100);
	startTask(tourne_pince_droitT);
	wait1Msec(100);
	avance_nulle_anyway(170, &dist, &done, &obs);

	startTask(sort_verrinT);
	wait1Msec(5000);

	recule_nulle_anyway(160, &dist, &done, &obs);
	wait1Msec(90000);
}
